...
public class OSSClientUtil {
    ...
    protected static String accessKeyId  = "LTAIbMndpzS7bTfz";
    protected static String accessKeySecret  = "28dvvWroAkAbnUrWv5C9oRewVjPAHt";
    protected static String bucketName  = "blogvillage";
    //文件存储目录
